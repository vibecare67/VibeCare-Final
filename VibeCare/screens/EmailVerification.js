...
function EmailVerification({ navigation }) {
  ...
  const handleForgotPassword = () => {
    if (EmailError || !Email) {
      ...
      return; // No need for navigation logic here.
    }
  ...
  .then((res) => {
    ...
    setTimeout(() => {
      ...
      navigation.navigate("VerifyOtpScreen", { Email, userId }); // pass Email and userId
    }, 1000);
  })
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Verify your email to login</Text>
